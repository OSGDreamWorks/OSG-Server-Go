...
local CS_PINGRESULT = protobuf.Descriptor();
local CS_PINGRESULT_SERVER_TIME_FIELD = protobuf.FieldDescriptor();
...
CS_PINGRESULT_SERVER_TIME_FIELD.name = "server_time"
CS_PINGRESULT_SERVER_TIME_FIELD.full_name = ".protobuf.CS_PingResult.server_time"
CS_PINGRESULT_SERVER_TIME_FIELD.number = 1
CS_PINGRESULT_SERVER_TIME_FIELD.index = 0
CS_PINGRESULT_SERVER_TIME_FIELD.label = 2
CS_PINGRESULT_SERVER_TIME_FIELD.has_default_value = false
CS_PINGRESULT_SERVER_TIME_FIELD.default_value = 0
CS_PINGRESULT_SERVER_TIME_FIELD.type = 13
CS_PINGRESULT_SERVER_TIME_FIELD.cpp_type = 3

CS_PINGRESULT.name = "CS_PingResult"
CS_PINGRESULT.full_name = ".protobuf.CS_PingResult"
CS_PINGRESULT.nested_types = {}
CS_PINGRESULT.enum_types = {}
CS_PINGRESULT.fields = {CS_PINGRESULT_SERVER_TIME_FIELD}
CS_PINGRESULT.is_extendable = false
CS_PINGRESULT.extensions = {}

CS_PingResult = protobuf.Message(CS_PINGRESULT)
