...
AL_CHECKACCOUNTRESULT_SESSIONKEY_FIELD.number = 2
AL_CHECKACCOUNTRESULT_SESSIONKEY_FIELD.index = 1
...
AL_CHECKACCOUNTRESULT_UID_FIELD.number = 3
AL_CHECKACCOUNTRESULT_UID_FIELD.index = 2
...
AL_CHECKACCOUNTRESULT_ERRMSG_FIELD.number = 4
AL_CHECKACCOUNTRESULT_ERRMSG_FIELD.index = 3
...
AL_CHECKACCOUNTRESULT.fields = {AL_CHECKACCOUNTRESULT_RESULT_FIELD, AL_CHECKACCOUNTRESULT_SESSIONKEY_FIELD, AL_CHECKACCOUNTRESULT_UID_FIELD, AL_CHECKACCOUNTRESULT_ERRMSG_FIELD}
