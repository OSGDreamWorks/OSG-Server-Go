...
func (client *Client) input() {
	...
	//断线回调
	for _, f := range client.discallback {
		f(err)
	}
}
...
//错误回调
func (client *Client) AddDisCallback(f func(err error)) {
	client.discallback = append(client.discallback, f)
}
